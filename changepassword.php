<?php
include('includes/changepassword.inc.php'); // Include the forgetpassword.inc.php file at the top
...
<head>
    ...
    <title>Change Password Dashboard | Online Clearance System</title>
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-sm">
                        <form action="includes/changepassword.inc.php" role="form" method="POST">
                            ...
                            <div><br>
                                <button class="btn btn-sm btn-success pull-left m-t-n-xs" type="submit"
                                    name="btnchange">
                                    Change Password
                                </button>
                            </div>
