...
<head>
    ...
    <title>Complains & Enquiries | Online Clearance System</title>
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div
                    ...
                    <h3 class="h3">Complains & Enquiries</h3>
                ...
                <form class="needs-validation" action="includes/complain.inc.php" method="post">
                    <div class="row g-3">
                        <div class="col-sm-6">
                            <h6>Subject:</h6>
                            <input class="form-control" type="text" name="subject" id="subject" required>
                        </div>
                        <h6>Complain/Enquiry:</h6>
                        <textarea class="form-control" name="message" id="message" rows="4" required></textarea>
                        <button class="w-25 btn btn-success btn-md" type="submit" value="Submit"
