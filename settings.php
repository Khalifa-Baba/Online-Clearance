...
<head>
    ...
    <title>Profile Settings | Online Clearance System</title>
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <img src="uploads/<?php echo $picture ?>" alt="image" width="142" height="153"
                    ...
                    <form action="includes/settings.inc.php" method="POST" enctype="multipart/form-data">
                        ...
                        <input class="btn btn-success btn-sm" type="file" style="" value="<?php echo $picture ?>" name="picture">
                        <button class="btn btn-success btn-sm" type="submit" value="Change" name="update">Update Image</button>
                        <br><br>
                    </form>
                        ...
                        <div>
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" id="firstName" placeholder=""
                                    value="<?php echo $firstname ?>" name="first">
                            </div>
                            <h6>Surname:</h6>
                            <div class="col-sm-6">
                                <input type="text" class="form-control" id="lastName" placeholder=""
                                    value="<?php echo $lastname ?>" name="last">
                            </div>
                        </div>
                        <h6>Email:</h6>
                        <div class="col-sm-6">
                            <input type="text" class="form-control" placeholder="" value="<?php echo $email; ?>"
                                name="email">
                        </div>

                        <h6>Phone Number:</h6>
                        <div class="col-sm-6">
                            <input type="text" class="form-control" placeholder="" value="<?php echo $phone_no; ?>"
                                name="number">
                        </div>

                        <h6>Session:</h6>
                        <div class="col-sm-6">
                            <input type="text" class="form-control" placeholder="<?php echo $session; ?>" value="<?php echo $session; ?>"
                                name="session">
                        </div>
                        <br>
                </div>
                <button class="btn btn-success btn-md" type="submit" value="Change" name="save">Save
                    Settings</button>
                </form>
        </div><br>
        </main>
