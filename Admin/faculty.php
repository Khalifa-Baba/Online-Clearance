...
<head>
    ...
    <title>Manage Faculty | Online Clearance System</title>
        ...
        <div class="row">
                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="list-unstyled ps-3 collapse show" id="forms-collapse" style="">
                                <li><a class="nav-link align-text-bottom" href="#">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div
                    ...
                    <h3 class="h3">Faculties Management</h3>
                ...
                <h6>Remove Existing Faculty</h6><br>
                <div class="col-8">
