...
<head>
    ...
    <title>Admin Sign-in Form | Online Clearance System</title>
...
<nav class="navbar navbar-expand-md navbar-white fixed-top bg-white">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            ...
            <a class="navbar-brand d-flex" href="../Staffs/staff_login.php">Staff</a>
        </div>
    </div>
...
<body class="text-center">
    ...
    <main class="w-100 m-auto">
        ...
        <div class="form-signin w-50 m-auto">
            <form class="container-sm" action="../includes/admin_login.inc.php" method="post">
                <!-- <img class="mb-4" src="../My Sofware/images/UDUSlogo.jpg" alt="UDUS Logo" width="100" height="100"> -->
                <!-- <h1 class="h3 mb-3 fw-normal">Please Sign in</h1> -->
                <h2 class="">Login as Admin</h2><br>
