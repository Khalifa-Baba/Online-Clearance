...
<head>
    ...
    <title>Manage Students | Online Clearance System</title>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <h6>Add New Session</h6><br>
                <div class="panel-body">
                    <form method="post" class="addSession" role="form" class="needs-validation">
                        <div class="col-6">
                            <label class="form-label">Session</label>
                            <input type="text" name="session" id="session_id" class="form-control">
                        </div><br>
                ...
                <h6>Remove Existing Session</h6><br>
                <div class="col-10">
