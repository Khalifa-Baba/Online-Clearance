<?php
session_start();
include('includes/session.inc.php'); // Include the forgetpassword.inc.php file at the top
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div
                    ...
                    <h3 class="h3">Clearance Status</h3>
                ...
                <div class="table-responsive">
                    ...
                    <h5>Your Clearance Status</h5>
                    <table class="table table-striped table-sm">
                        <?php include('clearanceStatus.php'); ?>
                        <thead>
                            <tr>
                                ...
                                <th scope="col">Student Affairs</th>
                                <th scope="col">Sport Director</th>
                                <th scope="col">Chief Security</th>
                                <th scope="col">Hostel (If Applicable)</th>
                            </tr>
                        </thead><br>
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <?php echo $libraryStatus ?>
                                </td>
                                <td>
                                    <?php echo $clinicStatus ?>
                                </td>
                                <td>
                                    <?php echo $bursaryStatus ?>
                                </td>
                                <td>
                                    <?php echo $examOfficeStatus ?>
                                </td>
                                <td>
                                    <?php echo $studentAffairsStatus ?>
                                </td>
                                <td>
                                    <?php echo $sportDirectorStatus ?>
                                </td>
                                <td>
                                    <?php echo $chiefSecurityStatus ?>
                                </td>
                                <td>
                                    <?php echo $hostelStatus ?>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                    ...
                    <?php
                    include('applicationStatus.php');
                    if ($status === 'Completed'): ?>
                        <form action="view_certificate.php" method="post">
                            <button type="submit" class="btn btn-sm btn-success pull-left m-t-n-xs">Proceed with Clearance
                                Report
                                Printout</button>
                        </form>
                    <?php endif; ?>
