...
<head>
    ...
    <title>Student's Record | Online Clearance System</title>
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div
                    ...
                    <h3 class="h3">Student's Record</h3>
                                ...
                                <?php if ($row[$department] == "0"): ?>
                                    <tr>
                                        ...
                                        while ($rows = mysqli_fetch_assoc($results)) { ?>
                                            <td>
                                                <?php echo $rows['start_year'] ?>
                                            </td>
                                            <td>
                                                <?php echo $rows['end_year'] ?>
                                            </td>
                                            <td><a href="../uploads/<?php echo $rows['idcard'] ?>" target="_blank">View ID Card</a>
                                            </td>
                                            <td><a href="../uploads/<?php echo $rows['result'] ?>" target="_blank">View Result</a>
                                            </td>
                                            <td><a href="../uploads/<?php echo $rows['fees'] ?>" target="_blank">View Receipt</a>
                                            </td>
                                        <?php } ?>
                                        <td>
                                            <button class="btn btn-sm btn-success" data-bs-toggle="collapse"
                                                aria-expanded="false" data-bs-target="#more" aria-controls="more"
                                                name="more">More</button>

                                            <table class="table table-striped table-sm ps-3 collapse show" id="more">
                                                <thead>
                                                    <tr>
                                                        <th scope="col">Library ID Card</th>
                                                        <th scope="col">Sport ID Card</th>
                                                        <th scope="col">Clinic Form</th>
                                                    </tr>
                                                </thead>
                                                ...
                                                <tbody>
                                                    ...
                                                    while ($rows = mysqli_fetch_assoc($results)) { ?>
                                                        <tr>
                                                            <td><a href="../uploads/<?php echo $rows['library_idcard'] ?>"
                                                                    target="_blank">View</a>
                                                            </td>
                                                            <td><a href="../uploads/<?php echo $rows['sport_idcard'] ?>"
                                                                    target="_blank">View</a>
                                                            </td>
                                                            <td><a href="../uploads/<?php echo $rows['clinic_form'] ?>"
                                                                    target="_blank">View</a>
                                                            </td>
                                                        </tr>
                                                    <?php } ?>
                                        ...
                                        <td>
                                            <form action="" method="POST" class="needs-validation"><button type="submit"
                                                    class="btn btn-sm btn-success" name="clear">Clear Student</button>
                                                <?php
                                                if (isset($_POST["clear"])) {
                                                    $update = "UPDATE `clearance_status` SET $department = 1 WHERE adm_no = $adm_no";
                                                    mysqli_query($conn, $update); ?>
                                                    <script>
                                                        alert('<?php echo $row['name'] ?> is now Cleared');
                                                    </script>
                                                    <?php break;
                                                } ?>
                                            </form>
