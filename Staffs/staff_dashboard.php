...
<head>
    ...
    <title>Clearance Staffs' Dashboard | Online Clearance System</title>
                            ...
                            while ($row = mysqli_fetch_assoc($result)) { ?>
                                <tr>
                                    ...
                                    <?php if ($row[$department] == "0"): ?>
                                        <td><a href="student_record.php"><button class="btn btn-sm btn-success">View
                                                    Record</button></a></td>
                                    <?php elseif ($row[$department] == "2"): ?>
                                        <td>No student Record</td>
                                    <?php else: ?>
                                        <td>cleared_student</td>
                                    <?php endif; ?>
                                <?php } ?>
                            </tr>
                            </select>
