    ...
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            ...
            try {
                ...
                // $mail->addAddress('udusonlineclearance@gmail.com'); //Name is optional
                ...
                $sqlUpdate = "UPDATE `students` SET `pwd`='$newPassword' WHERE `email`='$email'";
        ...
        header("refresh:0;url= ../forgetpassword.php?InvalidEmail");
        exit();
    }
} else { ?>
    <script>
